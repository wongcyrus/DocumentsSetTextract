...
This is a sample template for documents-set-textract - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name documents-set-textract --tail
```
...
```bash
aws cloudformation delete-stack --stack-name documents-set-textract
```
